...
struct AppleMapsAutocompleteView: View {
    ...
    var onLocationSelected: (String) -> Void // Callback to return the selected location
            ...
            VStack {
                ...
                List(suggestions, id: \.self) { mapItem in
                    Button(action: {
                        ...
                        onLocationSelected(locationName) // Pass the selected location back to the parent
                    }) {
    ...
    // Fetch suggestions using MKLocalSearch
