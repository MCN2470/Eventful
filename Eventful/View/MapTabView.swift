...
struct CustomAnnotation: Identifiable {
    ...
    let coordinate: CLLocationCoordinate2D // The location of the pin
    let title: String? // Optional title for the pin
}

// The main view for the map with search, route, and annotations
struct MapTabView: View {
    ...
    @State private var showPermissionDeniedAlert = false // Permission denied alert
...
// A helper view to display the route as a polyline overlay
...
// UIViewRepresentable to draw the polyline on the map
